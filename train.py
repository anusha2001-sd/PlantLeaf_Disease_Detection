...
def process(path):
    ...
    decay_rate=0.9)
        ...
        plt.savefig('results/Mobilenet_Training and validation accuracy.png') 
        plt.pause(5)
        ...
        plt.xlabel('epoch')
        plt.legend(['train', 'Validation'], loc='upper left')
        plt.savefig('results/Mobilenet_Training and validation Loss.png') 
        plt.pause(5)
        plt.show(block=False)
        plt.close()
        model.save('Leafdisease_mobilenet1.h5')
       ...
       # acc = (cm[0, 0] + cm[1, 1]) / total
        ...
        cm_display.plot()
        plt.savefig("results/Mobilenet_CM.png")
        plt.show()
        fpr = {}
        tpr = {}
        thresh ={}
        ...
        plt.legend(loc='best')
        plt.savefig('results/Mobilenet-Multiclass ROC',dpi=300);
        plt.show() 
